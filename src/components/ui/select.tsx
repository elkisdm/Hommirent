...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-neutral-700/50 bg-neutral-900/50 px-3 py-2 text-sm ring-offset-background backdrop-blur-md placeholder:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 transition-shadow duration-200 focus:shadow-glow-primary-sm focus:border-primary focus:bg-neutral-900/60",
      className
    )}
    {...props}
  >
